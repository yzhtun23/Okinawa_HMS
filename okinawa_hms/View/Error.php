    ...
    <div class="container" style="margin-top:80px; margin-bottom:220px;">
      <div class="row centered">
        <center>
          ...
          <h3>You are unable to load any pages</h3>
          <br>
          <br>
          <h2 style="margin-bottom:20px;"><font color='red'><b>Pleasae Try Again!!!!!</b> </font></h4>
            <h2 style="margin-bottom:20px;"><font color='blue'><b>Click Home</b> </font></h4>
            </center>
          </div>
        </div>
      </div>
